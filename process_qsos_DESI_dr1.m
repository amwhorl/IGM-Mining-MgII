...
for quasar_ind = 378 %1:numel(all_wavelengths)
...
%         end
         ...
         if(plotting==1) 
            ...
            pltQSO(this_flux, this_wavelengths, this_mu, MgII_muL2, MgII_muL1, this_noise_variance, ttl, fid,this_pixel_mask(ind),ind_not_remove)
            % figure(num_MgII)
            % clf("reset")

% generate_MgII_samples: generates MgII parameter samples from training
% catalog
...
MgII_catalog = load('/home/cosmic/IGM-Mining-Aaron/MGII/output/Seyfert_MgII_cat/processed/MgII-cat.mat');
...
W_r_1548_samples = nan([num_MgII_samples,1]);
W_r_1550_samples = nan([num_MgII_samples,1]);

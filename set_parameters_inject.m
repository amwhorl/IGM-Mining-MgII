...
load('/home/cosmic/IGM-Mining-Aaron/MGII/output/dr1/processed/processed_sigma_125_Spline_2200-2300_null_search.mat')
null_QSO_ind = (p_no_MgII(:,1) > 0.5) & (fit_chi2 < 0.15);
...
num_MgII_samples         = 10000;                  % number of parameter samples
alpha                    = 0.70;                    % weight of KDE component in mixture
uniform_min_log_nMgII     = 12;                   % range of column density samples    [cm⁻²]
uniform_max_log_nMgII     = 18;                   % from uniform distribution
...
testing_set_name = 'inject_abs_N12-18_sig5-75';

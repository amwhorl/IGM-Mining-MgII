...
for quasar_ind = 1:numel(all_wavelengths)
    ...
    this_isAbs_05       =     all_isAbs{quasar_ind,1};
    this_isAbs_07       =     all_isAbs{quasar_ind,2};
    this_isAbs_10       =     all_isAbs{quasar_ind,3};
    this_isAbs_15       =     all_isAbs{quasar_ind,4};
    this_isAbs_20       =     all_isAbs{quasar_ind,5};
    ...
    masked_abs_pixels(quasar_ind,1) = nnz(this_isAbs_05 & masked_regions)/nnz(this_isAbs_05);
    masked_abs_pixels(quasar_ind,2) = nnz(this_isAbs_07 & masked_regions)/nnz(this_isAbs_07);
    masked_abs_pixels(quasar_ind,3) = nnz(this_isAbs_10 & masked_regions)/nnz(this_isAbs_10);
    masked_abs_pixels(quasar_ind,4) = nnz(this_isAbs_15 & masked_regions)/nnz(this_isAbs_15);
    masked_abs_pixels(quasar_ind,5) = nnz(this_isAbs_20 & masked_regions)/nnz(this_isAbs_20);
...
variables_to_save = {'releaseTest', 'training_set_name', ...
    ...
    'map_z_MgIIL2', 'map_N_MgIIL2', 'map_sigma_MgIIL2' ,'p_MgII', 'REW_2796','REW_2803',...
